...
const page = () => {
  ...
  async function handleSubmit(e) {
    ...
    if (!isFormValid() && isBothPasswordMatch && isValidEmail) {
            ...
            <div className="bg-[#000000ba] rounded-md w-full md:w-96 mx-auto py-5 px-3 md:px-10">
              ...
              <div className="grid gap-3 ">
                ...
                <input
                  ...
                  type="text"
                  className={`bg-[#333333] ${!isValidEmail ? 'border border-red-500 ' : 'border border-transparent'}  outline-none hover:outline-none placeholder:text-gray-500 rounded-sm px-3 py-2`}
                  placeholder="Email"
                  name="email"
                  onChange={handleChange}
                />
                ...
                />
                  ...
                  <input
                    ...
                    className={`bg-[#333333] ${!isBothPasswordMatch ? 'border border-red-500 ' : 'border border-transparent'} placeholder:text-gray-500 rounded-sm px-3 py-2 outline-none hover:outline-none`}
                    placeholder="Re-type Password"
                    name="password2"
                    onChange={(e) => setPassword2(e.target.value)}
                  />
                
                <button type="submit" className="bg-emerald-600  hover:bg-emerald-800 py-1.5 rounded-sm">
                  Register
                </button>

                <div className="grid gap-2">
                  <button onClick={handleGoogle} className="bg-transparent text-white hover:bg-white hover:text-black rounded  flex items-center gap-2 py-1 px-3 border-white border transition-all duration-300">
                    <p>
